(function ($) {
    ...
    function galleryManager(el, options) {
        ...
        photoTemplate += '<a href="#" class="btn btn-xs btn-danger"><span class="deletePhoto"> <span class="glyphicon glyphicon-remove"></span></span></a>' +
                ...
                for (var i = 0; i < filesCount; i++) {
                    ...
                    xhr.onload = function () {
                        ...
                        if (this.status == 200) {
                            ...
                            //console.log(resp);
                            if (resp.status  == 504 || (resp.status  == 505)) {
                                alert(resp.error);
                            } else {
