...
function athemes_content_nav( $nav_id ) {
	...
	<?php if ( is_single() ) : // navigation links for single posts ?>
		...
		<?php previous_post_link( '<div class="nav-previous"><span>Previous Article</span>%link</div>', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'athemes' ) . '</span> %title' ); ?>
		<?php next_post_link( '<div class="nav-next"><span>Next Article</span>%link</div>', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'athemes' ) . '</span>' ); ?>

	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>

		<?php if ( get_next_posts_link() ) : ?>
		<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older Articles', 'athemes' ) ); ?></div>
		<?php endif; ?>

		<?php if ( get_previous_posts_link() ) : ?>
		<div class="nav-next"><?php previous_posts_link( __( 'Newer Articles <span class="meta-nav">&rarr;</span>', 'athemes' ) ); ?></div>
		<?php endif; ?>
